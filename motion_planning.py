...
from planning_utils import a_star, heuristic, create_grid, get_latlog, random_free_location_lla, smooth_path
...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        lat0, lon0 = get_latlog('colliders.csv')
        ...
        grid_start = (int(curr_local_position[0]) - north_offset, 
                      int(curr_local_position[1]) - east_offset)
        
        # Set goal as some arbitrary position on the grid
        #grid_goal = (-north_offset + 10, -east_offset + 10)
        # TODO: adapt to set goal as latitude / longitude position and convert
        # Pick a point in C_free in the grid
